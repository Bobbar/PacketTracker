...
Public Sub DrawTimeLine()
    ...
    For i = 0 To Entry - 1
        ...
        With frmTimeLine
            ...
            Load .lblNote(i)
            .lblNote(i).Caption = strTimelineComments(i)
            ...
            .lblAction(i).ToolTipText = "Entry date: " & TicketDate(i)
    ...
    frmTimeLine.lblPacketAge.Top = frmTimeLine.lnVisScale.Y1 + 40
